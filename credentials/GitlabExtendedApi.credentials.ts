	...
	properties: INodeProperties[] = [
                {
                        ...
                        description:
                                'Base URL of your GitLab instance, for example "https://gitlab.com"',
                },
                {
                ...
                },
                {
                        ...
                        default: '',
                        description:
                                'Namespace or owner of the project. Ignored if "Project ID" is set.',
                },
                {
                        ...
                        default: '',
                        description:
                                'Project slug or name. Ignored if "Project ID" is set.',
                },
                {
                        ...
                        default: 0,
                        description:
                                'Numeric project ID. Takes precedence over owner and name if provided.',
                },
	];
